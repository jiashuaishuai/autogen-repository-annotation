 ...
 * @property DO_NOT_HANDLE 不做任何处理
 * @property ONLY_HANDLE_RESULT 只处理结果不做线程操作
 * @property DEFAULT 使用默认处理操作
 */
enum class ThreadSchedulerType {

    HANDLE_RESULT_TO_MAIN, SWITCH_MAIN, HANDLE_RESULT_TO_IO, SWITCH_IO, DO_NOT_HANDLE, ONLY_HANDLE_RESULT, DEFAULT
